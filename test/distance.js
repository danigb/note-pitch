...
vows.describe('Pitch distance').addBatch({
  'test basics': function () {
    assert.equal(Note.distance('a2', 'c#3'), 'M3')
    assert.equal(Note.distance('a3', 'a2'), 'P-8')
  },
  'distances': function () {
    var intervals = Note.distance('a2', ['a2', 'c#3', 'e3', 'g#3'])
